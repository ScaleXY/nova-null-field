...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-NullField', __webpack_require__(3));
  Vue.component('detail-NullField', __webpack_require__(6));
  Vue.component('form-NullField', __webpack_require__(9));
});
